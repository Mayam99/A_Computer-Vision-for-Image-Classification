...
# -------------------------------------------------------
# 1. Register a custom Dense layer that ignores 'quantization_config'
# -------------------------------------------------------
...
def load_champion_model():
    ...
    # Load the model inside a custom object scope so our CustomDense is used
    with tf.keras.utils.custom_object_scope({'Dense': CustomDense}):
        # compile=False avoids extra compatibility issues with optimizer/loss
